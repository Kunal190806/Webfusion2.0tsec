    ...
    <div className="w-full bg-[#FAFAFA] min-h-screen font-sans">
      ...
      <section className="bg-[#16352F] text-white py-24 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-[#D7F24A] rounded-full blur-3xl"></div>
        </div>
        
        <div className="container mx-auto px-6 relative z-10 max-w-[1200px]">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">Our Campus <br/><span className="text-[#D7F24A]">Impact</span></h1>
        ...
        <div className="container mx-auto px-6 max-w-[1200px]">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-black text-[#D7F24A] rounded-full flex items-center justify-center font-bold text-xl">4</div>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-black text-[#D7F24A] rounded-full flex items-center justify-center font-bold text-xl"><TrendingUp className="w-6 h-6"/></div>
                  <div>
            ...
            <div className="flex-1 w-full max-w-md bg-[#16352F] rounded-[3rem] p-10 text-white relative overflow-hidden">
               <div className="absolute top-0 right-0 w-32 h-32 bg-[#D7F24A] rounded-full blur-2xl opacity-20 -translate-y-1/2 translate-x-1/2"></div>
               <h3 className="text-xl font-medium mb-2 text-white/80">You have saved approx</h3>
               <div className="text-6xl font-bold font-serif mb-8 text-[#D7F24A]">₹4,250</div>
